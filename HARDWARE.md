# Hardware Guide for vLLM (Air-Gapped, NVIDIA A100)
...
## 7) Requisitos de plataforma (software/firmware)
...
## 8) Flujo de despliegue air-gapped
...
## 9) Checklist de aceptacion de hardware
...
## 10) Consideraciones de seguridad (air-gapped)
